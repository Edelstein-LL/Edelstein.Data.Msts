...
[Serializable]
public class LiveMissionRewardMst : IGameMst, ISerializable
{
    [Key]
    ...
    public LiveMissionRewardMst() { }

    protected LiveMissionRewardMst(SerializationInfo info, StreamingContext context)
    {
