...
[Serializable]
public class ShopRewardMst : IGameMst, ISerializable
{
    [Key]
    ...
    protected ShopRewardMst(SerializationInfo info, StreamingContext context)
    {
        ...
        IsBonus = info.GetUInt32("_isBonus");
    ...
    public void GetObjectData(SerializationInfo info, StreamingContext context)
    {
        ...
        info.AddValue("_isBonus", IsBonus);
