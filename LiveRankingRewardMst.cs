...
[Serializable]
public class LiveRankingRewardMst : IGameMst, ISerializable
{
    ...
    public LiveRankingRewardMst() { }

    protected LiveRankingRewardMst(SerializationInfo info, StreamingContext context)
    {
