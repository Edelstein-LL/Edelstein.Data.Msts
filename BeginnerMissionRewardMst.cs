...
[Serializable]
public class BeginnerMissionRewardMst : IGameMst, ISerializable
{
    ...
    public BeginnerMissionRewardMst() { }

    protected BeginnerMissionRewardMst(SerializationInfo info, StreamingContext context)
    {
