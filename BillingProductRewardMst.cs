...
[Serializable]
public class BillingProductRewardMst : IGameMst, ISerializable
{
    ...
    public BillingProductRewardMst() { }

    protected BillingProductRewardMst(SerializationInfo info, StreamingContext context)
    {
