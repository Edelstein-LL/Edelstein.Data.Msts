...
[Serializable]
public class LoginBonusRewardMst : IGameMst, ISerializable
{
    ...
    public LoginBonusRewardMst() { }

    protected LoginBonusRewardMst(SerializationInfo info, StreamingContext context)
    {
