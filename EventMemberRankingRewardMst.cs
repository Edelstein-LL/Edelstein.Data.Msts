...
[Serializable]
public class EventMemberRankingRewardMst : IGameMst, ISerializable
{
    ...
    public EventMemberRankingRewardMst() { }

    protected EventMemberRankingRewardMst(SerializationInfo info, StreamingContext context)
    {
