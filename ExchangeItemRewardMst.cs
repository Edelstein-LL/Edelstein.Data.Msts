...
[Serializable]
public class ExchangeItemRewardMst : IGameMst, ISerializable
{
    [Key]
    ...
    public ExchangeItemRewardMst() { }

    protected ExchangeItemRewardMst(SerializationInfo info, StreamingContext context)
    {
