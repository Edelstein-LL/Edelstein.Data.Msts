...
public class LocationRewardMst : IGameMst, ISerializable
{
    ...
    public LocationRewardMst() { }

    protected LocationRewardMst(SerializationInfo info, StreamingContext context)
    {
