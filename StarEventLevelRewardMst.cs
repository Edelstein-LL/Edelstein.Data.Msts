...
[Serializable]
public class StarEventLevelRewardMst : IGameMst, ISerializable
{
    ...
    public StarEventLevelRewardMst() { }

    protected StarEventLevelRewardMst(SerializationInfo info, StreamingContext context)
    {
