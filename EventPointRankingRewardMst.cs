...
public class EventPointRankingRewardMst : IGameMst, ISerializable
{
    ...
    public EventPointRankingRewardMst() { }

    protected EventPointRankingRewardMst(SerializationInfo info, StreamingContext context)
    {
