...
[Serializable]
public class EventPointRewardMst : IGameMst, ISerializable
{
    ...
    public EventPointRewardMst() { }

    protected EventPointRewardMst(SerializationInfo info, StreamingContext context)
    {
